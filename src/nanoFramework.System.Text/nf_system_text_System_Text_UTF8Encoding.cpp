...
HRESULT Library_nf_system_text_System_Text_UTF8Encoding::GetBytes___I4__STRING__I4__I4__SZARRAY_U1__I4(
...
HRESULT Library_nf_system_text_System_Text_UTF8Encoding::GetChars___SZARRAY_CHAR__SZARRAY_U1__I4__I4(
    CLR_RT_StackFrame &stack)
{
    NATIVE_PROFILE_CLR_CORE();
    NANOCLR_HEADER();
...
HRESULT Library_nf_system_text_System_Text_UTF8Encoding::Helper__GetChars(CLR_RT_StackFrame &stack, bool fIndexed)
{
    ...
    NANOCLR_CHECK_HRESULT(
        Library_corlib_native_System_String::ConvertToCharArray(szText, stack.PushValueAndClear(), arrTmp, 0, -1));
