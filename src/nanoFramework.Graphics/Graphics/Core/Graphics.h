...
struct GraphicsDriver
{
  public:
    ...
    static void Screen_Flush(CLR_GFX_Bitmap &bitmap, CLR_UINT16 srcX, CLR_UINT16 srcY, CLR_UINT16 width, CLR_UINT16 height, CLR_UINT16 screenX, CLR_UINT16 screenY);
