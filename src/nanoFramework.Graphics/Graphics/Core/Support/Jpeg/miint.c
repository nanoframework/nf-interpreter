    ...
    JSAMPARRAY output_buf, JDIMENSION output_col, JSAMPLE* range_limit)
{
    ...
    CLR_INT32 locdwinptr, locdwqptr, locdwwsptr, locdwcounter, locdwrowctr;
    ...
    idct_row:
        ...
        ;; mm0 = > e3 | e2 | e1 | e0
            ...
            ;; value from array range_limitand store the final result
            ...
            ;; update address pointerand loop counter
