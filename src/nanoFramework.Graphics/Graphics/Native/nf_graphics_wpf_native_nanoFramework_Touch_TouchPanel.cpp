...
HRESULT Library_nf_graphics_wpf_native_nanoFramework_Touch_TouchPanel::SetCalibration___VOID__I4__SZARRAY_I2__SZARRAY_I2__SZARRAY_I2__SZARRAY_I2( CLR_RT_StackFrame& stack )
{
      NANOCLR_HEADER();
...
HRESULT Library_nf_graphics_wpf_native_nanoFramework_Touch_TouchPanel::GetCalibrationPointCount___VOID__BYREF_I4( CLR_RT_StackFrame& stack )
{
     NANOCLR_HEADER();
...
HRESULT Library_nf_graphics_wpf_native_nanoFramework_Touch_TouchPanel::StartCalibration___VOID( CLR_RT_StackFrame& stack )
{
      NANOCLR_HEADER();
...
HRESULT Library_nf_graphics_wpf_native_nanoFramework_Touch_TouchPanel::GetCalibrationPoint___VOID__I4__BYREF_I4__BYREF_I4( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_nf_graphics_wpf_native_nanoFramework_Touch_TouchPanel::EnableInternal___VOID__BOOLEAN( CLR_RT_StackFrame& stack )
{
     NANOCLR_HEADER();
   ...
   if (fInit)
   {
      NANOCLR_SET_AND_LEAVE(g_TouchPanelDriver.Initialize());
   }
   else
   {
      NANOCLR_SET_AND_LEAVE(g_TouchPanelDriver.Uninitialize());
   }
