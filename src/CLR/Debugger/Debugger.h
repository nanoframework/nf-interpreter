 ...
 * @file Debugger.h
 * @brief CLR Debugger
 * @ingroup CLR_Debugger
 */
#ifndef DEBUGGER_H
#define DEBUGGER_H

/**
 * @defgroup nanoFramework interpreter Debugger
...
/**
 * @brief CLR debugging commands
 *
 * Backwards compatible with .NETMF
 */
typedef enum CLR_DBG_Commands_Debugging
{
    CLR_DBG_Commands_c_Debugging_Execution_BasePtr =
    ...
    CLR_DBG_Commands_c_Debugging_Execution_Unlock =
    ...
    CLR_DBG_Commands_c_Debugging_Execution_SetCurrentAppDomain =
    ...
    CLR_DBG_Commands_c_Debugging_Thread_CreateEx =
    ...
    CLR_DBG_Commands_c_Debugging_Resolve_VirtualMethod =
        0x00020054, /* Resolves a virtual method to the actual implementation. */
    CLR_DBG_Commands_c_Debugging_Resolve_AppDomain =
    ...
    CLR_DBG_Commands_c_Debugging_Deployment_Status =
...
/**
 * @brief Access Memory Error Codes
 *
 * !!! MUST KEEP IN SYNC WITH nanoFramework.Tools.Debugger.WireProtocol.AccessMemoryErrorCodes (in managed code) !!!
 */
typedef enum AccessMemoryErrorCodes
{
    ...
    AccessMemoryErrorCode_FailedToAllocateReadBuffer =
        0x0020, /* failed to allocate buffer for read operation. better check heap */
