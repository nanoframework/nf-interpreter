...
HRESULT Library_graphics_native__Font::CharWidth___I4__CHAR( CLR_RT_StackFrame& stack )
{
...
HRESULT Library_graphics_native__Font::get_Height___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_AverageWidth___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_MaxWidth___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_Ascent___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_Descent___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_InternalLeading___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::get_ExternalLeading___I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::ComputeExtent___VOID__STRING__BYREF_I4__BYREF_I4__I4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::ComputeTextInRect___VOID__STRING__BYREF_I4__BYREF_I4__I4__I4__I4__I4__U4( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::GetFont( CLR_RT_HeapBlock* pThis, CLR_GFX_Font*& font )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
    NANOCLR_HEADER();
...
HRESULT Library_graphics_native__Font::GetFont( CLR_RT_StackFrame& stack, CLR_GFX_Font*& font )
{
    NATIVE_PROFILE_CLR_GRAPHICS();
