...
#if CONST_BITS == 8
#define FIX_1_082392200  ((CLR_INT32)  277)		/* FIX(1.082392200) */
#define FIX_1_414213562  ((CLR_INT32)  362)		/* FIX(1.414213562) */
#define FIX_1_847759065  ((CLR_INT32)  473)		/* FIX(1.847759065) */
#define FIX_2_613125930  ((CLR_INT32)  669)		/* FIX(2.613125930) */
#else
...
/* Multiply a DCTELEM variable by an CLR_INT32 constant, and immediately
 ...
 * declared CLR_INT32, so a 32-bit multiply will be used.
 */
