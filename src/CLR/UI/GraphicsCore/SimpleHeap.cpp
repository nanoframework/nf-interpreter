...
const CLR_UINT32 g_heapmem_used = 0;
#else
CLR_UINT32 g_heapmem_used = 0;
...
void SimpleHeap_Initialize( void* buffer, CLR_UINT32 length )
{
...
{
#if defined(SIMPLEHEAP_VERBOSE)
    CLR_UINT32 *p_heapmem_used = (CLR_UINT32 *) &g_heapmem_used;
