...
//****************************************************************************
static const double round_nums[8] = {0.5, 0.05, 0.005, 0.0005, 0.00005, 0.000005, 0.0000005, 0.00000005};
...
static unsigned dbl2stri(char *outbfr, double dbl, unsigned dec_digits)
{
    ...
    unsigned int index;
    for (index = 0; index < dec_digits; index++)
        mult *= 10;
