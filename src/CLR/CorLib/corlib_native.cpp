...
static const CLR_RT_MethodHandler method_lookup[] =
{
    ...
    NULL,
    NULL,
    Library_CorLib_System_Globalization_CultureInfo::get_CurrentUICultureInternal___STATIC__SystemGlobalizationCultureInfo,
    Library_CorLib_System_Globalization_CultureInfo::set_CurrentUICultureInternal___STATIC__VOID__SystemGlobalizationCultureInfo,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Object::Equals___BOOLEAN__OBJECT,
    Library_CorLib_System_Object::GetHashCode___I4,
    NULL,
    Library_CorLib_System_Object::MemberwiseClone___OBJECT,
    NULL,
    Library_CorLib_System_Object::ReferenceEquals___STATIC__BOOLEAN__OBJECT__OBJECT,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_String::CompareTo___I4__OBJECT,
    NULL,
    Library_CorLib_System_String::get_Chars___CHAR__I4,
    NULL,
    Library_CorLib_System_String::ToCharArray___SZARRAY_CHAR,
    Library_CorLib_System_String::ToCharArray___SZARRAY_CHAR__I4__I4,
    Library_CorLib_System_String::get_Length___I4,
    Library_CorLib_System_String::Split___SZARRAY_STRING__SZARRAY_CHAR,
    Library_CorLib_System_String::Split___SZARRAY_STRING__SZARRAY_CHAR__I4,
    Library_CorLib_System_String::Substring___STRING__I4,
    Library_CorLib_System_String::Substring___STRING__I4__I4,
    Library_CorLib_System_String::Trim___STRING__SZARRAY_CHAR,
    Library_CorLib_System_String::TrimStart___STRING__SZARRAY_CHAR,
    Library_CorLib_System_String::TrimEnd___STRING__SZARRAY_CHAR,
    Library_CorLib_System_String::_ctor___VOID__SZARRAY_CHAR__I4__I4,
    Library_CorLib_System_String::_ctor___VOID__SZARRAY_CHAR,
    Library_CorLib_System_String::_ctor___VOID__CHAR__I4,
    Library_CorLib_System_String::CompareTo___I4__STRING,
    Library_CorLib_System_String::IndexOf___I4__CHAR,
    Library_CorLib_System_String::IndexOf___I4__CHAR__I4,
    Library_CorLib_System_String::IndexOf___I4__CHAR__I4__I4,
    Library_CorLib_System_String::IndexOfAny___I4__SZARRAY_CHAR,
    Library_CorLib_System_String::IndexOfAny___I4__SZARRAY_CHAR__I4,
    Library_CorLib_System_String::IndexOfAny___I4__SZARRAY_CHAR__I4__I4,
    Library_CorLib_System_String::IndexOf___I4__STRING,
    Library_CorLib_System_String::IndexOf___I4__STRING__I4,
    Library_CorLib_System_String::IndexOf___I4__STRING__I4__I4,
    Library_CorLib_System_String::LastIndexOf___I4__CHAR,
    Library_CorLib_System_String::LastIndexOf___I4__CHAR__I4,
    Library_CorLib_System_String::LastIndexOf___I4__CHAR__I4__I4,
    Library_CorLib_System_String::LastIndexOfAny___I4__SZARRAY_CHAR,
    Library_CorLib_System_String::LastIndexOfAny___I4__SZARRAY_CHAR__I4,
    Library_CorLib_System_String::LastIndexOfAny___I4__SZARRAY_CHAR__I4__I4,
    Library_CorLib_System_String::LastIndexOf___I4__STRING,
    Library_CorLib_System_String::LastIndexOf___I4__STRING__I4,
    Library_CorLib_System_String::LastIndexOf___I4__STRING__I4__I4,
    Library_CorLib_System_String::ToLower___STRING,
    Library_CorLib_System_String::ToUpper___STRING,
    Library_CorLib_System_String::Trim___STRING,
    NULL,
    NULL,
    Library_CorLib_System_String::Equals___STATIC__BOOLEAN__STRING__STRING,
    Library_CorLib_System_String::op_Equality___STATIC__BOOLEAN__STRING__STRING,
    Library_CorLib_System_String::op_Inequality___STATIC__BOOLEAN__STRING__STRING,
    Library_CorLib_System_String::Compare___STATIC__I4__STRING__STRING,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_String::Concat___STATIC__STRING__STRING__STRING,
    Library_CorLib_System_String::Concat___STATIC__STRING__STRING__STRING__STRING,
    Library_CorLib_System_String::Concat___STATIC__STRING__STRING__STRING__STRING__STRING,
    Library_CorLib_System_String::Concat___STATIC__STRING__SZARRAY_STRING,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Exception::get_StackTrace___STRING,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Array::System_Collections_IList_get_Item___OBJECT__I4,
    Library_CorLib_System_Array::System_Collections_IList_set_Item___VOID__I4__OBJECT,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Array::get_Length___I4,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Array::Copy___STATIC__VOID__SystemArray__I4__SystemArray__I4__I4,
    Library_CorLib_System_Array::Clear___STATIC__VOID__SystemArray__I4__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Array::TrySzIndexOf___STATIC__BOOLEAN__SystemArray__I4__I4__OBJECT__BYREF_I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_BitConverter::get_IsLittleEndian___STATIC__BOOLEAN,
    Library_CorLib_System_BitConverter::DoubleToInt64Bits___STATIC__I8__R8,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__BOOLEAN,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__CHAR,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__R8,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__R4,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__I8,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__I2,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__U4,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__U8,
    Library_CorLib_System_BitConverter::GetBytes___STATIC__SZARRAY_U1__U2,
    Library_CorLib_System_BitConverter::Int64BitsToDouble___STATIC__R8__I8,
    Library_CorLib_System_BitConverter::ToBoolean___STATIC__BOOLEAN__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToChar___STATIC__CHAR__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToDouble___STATIC__R8__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToInt16___STATIC__I2__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToInt32___STATIC__I4__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToInt64___STATIC__I8__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToSingle___STATIC__R4__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToString___STATIC__STRING__SZARRAY_U1,
    Library_CorLib_System_BitConverter::ToString___STATIC__STRING__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToString___STATIC__STRING__SZARRAY_U1__I4__I4,
    Library_CorLib_System_BitConverter::ToUInt16___STATIC__U2__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToUInt32___STATIC__U4__SZARRAY_U1__I4,
    Library_CorLib_System_BitConverter::ToUInt64___STATIC__U8__SZARRAY_U1__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Collections_ArrayList::get_Item___OBJECT__I4,
    Library_CorLib_System_Collections_ArrayList::set_Item___VOID__I4__OBJECT,
    Library_CorLib_System_Collections_ArrayList::Add___I4__OBJECT,
    NULL,
    Library_CorLib_System_Collections_ArrayList::Clear___VOID,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Collections_ArrayList::Insert___VOID__I4__OBJECT,
    NULL,
    Library_CorLib_System_Collections_ArrayList::RemoveAt___VOID__I4,
    NULL,
    Library_CorLib_System_Collections_ArrayList::SetCapacity___VOID__I4,
    NULL,
    NULL,
    Library_CorLib_System_Console::OutNative___STATIC__VOID__STRING__BOOLEAN,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Double::CompareTo___STATIC__I4__R8__R8,
    Library_CorLib_System_Double::IsInfinity___STATIC__BOOLEAN__R8,
    Library_CorLib_System_Double::IsNaN___STATIC__BOOLEAN__R8,
    Library_CorLib_System_Double::IsNegativeInfinity___STATIC__BOOLEAN__R8,
    Library_CorLib_System_Double::IsPositiveInfinity___STATIC__BOOLEAN__R8,
    NULL,
    NULL,
    Library_CorLib_System_Convert::NativeToInt64___STATIC__I8__STRING__BOOLEAN__I8__I8__I4,
    Library_CorLib_System_Convert::NativeToDouble___STATIC__R8__STRING,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Convert::ToBase64String___STATIC__STRING__SZARRAY_U1__I4__I4__BOOLEAN,
    NULL,
    NULL,
    Library_CorLib_System_Convert::FromBase64CharArray___STATIC__SZARRAY_U1__SZARRAY_CHAR__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_TimeSpan::Equals___BOOLEAN__OBJECT,
    Library_CorLib_System_TimeSpan::ToString___STRING,
    NULL,
    NULL,
    Library_CorLib_System_TimeSpan::_ctor___VOID__I4__I4__I4,
    Library_CorLib_System_TimeSpan::_ctor___VOID__I4__I4__I4__I4,
    Library_CorLib_System_TimeSpan::_ctor___VOID__I4__I4__I4__I4__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_TimeSpan::CompareTo___I4__OBJECT,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_TimeSpan::Compare___STATIC__I4__SystemTimeSpan__SystemTimeSpan,
    Library_CorLib_System_TimeSpan::Equals___STATIC__BOOLEAN__SystemTimeSpan__SystemTimeSpan,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_DateTime::_ctor___VOID__I4__I4__I4__I4__I4__I4__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_DateTime::get_Day___I4,
    Library_CorLib_System_DateTime::get_DayOfWeek___SystemDayOfWeek,
    Library_CorLib_System_DateTime::get_DayOfYear___I4,
    Library_CorLib_System_DateTime::get_Hour___I4,
    NULL,
    Library_CorLib_System_DateTime::get_Millisecond___I4,
    Library_CorLib_System_DateTime::get_Minute___I4,
    Library_CorLib_System_DateTime::get_Month___I4,
    Library_CorLib_System_DateTime::get_Second___I4,
    NULL,
    NULL,
    Library_CorLib_System_DateTime::get_Year___I4,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_DateTime::DaysInMonth___STATIC__I4__I4__I4,
    NULL,
    Library_CorLib_System_DateTime::get_UtcNow___STATIC__SystemDateTime,
    Library_CorLib_System_DateTime::get_Today___STATIC__SystemDateTime,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Delegate::Equals___BOOLEAN__OBJECT,
    NULL,
    Library_CorLib_System_Delegate::Combine___STATIC__SystemDelegate__SystemDelegate__SystemDelegate,
    Library_CorLib_System_Delegate::Remove___STATIC__SystemDelegate__SystemDelegate__SystemDelegate,
    Library_CorLib_System_Delegate::op_Equality___STATIC__BOOLEAN__SystemDelegate__SystemDelegate,
    Library_CorLib_System_Delegate::op_Inequality___STATIC__BOOLEAN__SystemDelegate__SystemDelegate,
    Library_CorLib_System_Diagnostics_Debugger::get_IsAttached___STATIC__BOOLEAN,
    Library_CorLib_System_Diagnostics_Debugger::Break___STATIC__VOID,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_GC::AnyPendingFinalizers___STATIC__BOOLEAN,
    NULL,
    Library_CorLib_System_GC::SuppressFinalize___STATIC__VOID__OBJECT,
    Library_CorLib_System_GC::ReRegisterForFinalize___STATIC__VOID__OBJECT,
    Library_CorLib_System_Globalization_DateTimeFormat::FormatDigits___STATIC__STRING__I4__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Guid::GenerateNewGuid___STATIC__SZARRAY_U1,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_MathInternal::Abs___STATIC__I4__I4,
    Library_CorLib_System_MathInternal::Min___STATIC__I4__I4__I4,
    Library_CorLib_System_MathInternal::Max___STATIC__I4__I4__I4,
    NULL,
    NULL,
    Library_CorLib_System_MulticastDelegate::op_Equality___STATIC__BOOLEAN__SystemMulticastDelegate__SystemMulticastDelegate,
    Library_CorLib_System_MulticastDelegate::op_Inequality___STATIC__BOOLEAN__SystemMulticastDelegate__SystemMulticastDelegate,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Number::FormatNative___STATIC__STRING__OBJECT__CHAR__I4,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Random::Next___I4,
    Library_CorLib_System_Random::Next___I4__I4,
    Library_CorLib_System_Random::NextDouble___R8,
    Library_CorLib_System_Random::NextBytes___VOID__SZARRAY_U1,
    Library_CorLib_System_Random::_ctor___VOID,
    Library_CorLib_System_Random::_ctor___VOID__I4,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Runtime_CompilerServices_RuntimeHelpers::InitializeArray___STATIC__VOID__SystemArray__SystemRuntimeFieldHandle,
    Library_CorLib_System_Runtime_CompilerServices_RuntimeHelpers::GetObjectValue___STATIC__OBJECT__OBJECT,
    Library_CorLib_System_Runtime_CompilerServices_RuntimeHelpers::RunClassConstructor___STATIC__VOID__SystemRuntimeTypeHandle,
    Library_CorLib_System_Runtime_CompilerServices_RuntimeHelpers::get_OffsetToStringData___STATIC__I4,
    Library_CorLib_System_Runtime_Remoting_RemotingServices::IsTransparentProxy___STATIC__BOOLEAN__OBJECT,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_Threading_AutoResetEvent::_ctor___VOID__BOOLEAN,
    Library_CorLib_System_Threading_AutoResetEvent::Reset___BOOLEAN,
    Library_CorLib_System_Threading_AutoResetEvent::Set___BOOLEAN,
    Library_CorLib_System_Threading_Interlocked::Increment___STATIC__I4__BYREF_I4,
    Library_CorLib_System_Threading_Interlocked::Decrement___STATIC__I4__BYREF_I4,
    Library_CorLib_System_Threading_Interlocked::Exchange___STATIC__I4__BYREF_I4__I4,
    Library_CorLib_System_Threading_Interlocked::CompareExchange___STATIC__I4__BYREF_I4__I4__I4,
    Library_CorLib_System_Threading_ManualResetEvent::_ctor___VOID__BOOLEAN,
    Library_CorLib_System_Threading_ManualResetEvent::Reset___BOOLEAN,
    Library_CorLib_System_Threading_ManualResetEvent::Set___BOOLEAN,
    Library_CorLib_System_Threading_Monitor::Enter___STATIC__VOID__OBJECT,
    Library_CorLib_System_Threading_Monitor::Exit___STATIC__VOID__OBJECT,
    Library_CorLib_System_Threading_Thread::_ctor___VOID__SystemThreadingThreadStart,
    Library_CorLib_System_Threading_Thread::Start___VOID,
    Library_CorLib_System_Threading_Thread::Abort___VOID,
    Library_CorLib_System_Threading_Thread::Suspend___VOID,
    Library_CorLib_System_Threading_Thread::Resume___VOID,
    Library_CorLib_System_Threading_Thread::get_Priority___SystemThreadingThreadPriority,
    Library_CorLib_System_Threading_Thread::set_Priority___VOID__SystemThreadingThreadPriority,
    Library_CorLib_System_Threading_Thread::get_ManagedThreadId___I4,
    Library_CorLib_System_Threading_Thread::get_IsAlive___BOOLEAN,
    Library_CorLib_System_Threading_Thread::Join___VOID,
    Library_CorLib_System_Threading_Thread::Join___BOOLEAN__I4,
    Library_CorLib_System_Threading_Thread::Join___BOOLEAN__SystemTimeSpan,
    Library_CorLib_System_Threading_Thread::get_ThreadState___SystemThreadingThreadState,
    Library_CorLib_System_Threading_Thread::Sleep___STATIC__VOID__I4,
    NULL,
    Library_CorLib_System_Threading_Thread::get_CurrentThread___STATIC__SystemThreadingThread,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Threading_Timer::Dispose___VOID,
    Library_CorLib_System_Threading_Timer::_ctor___VOID__SystemThreadingTimerCallback__OBJECT__I4__I4,
    Library_CorLib_System_Threading_Timer::_ctor___VOID__SystemThreadingTimerCallback__OBJECT__SystemTimeSpan__SystemTimeSpan,
    Library_CorLib_System_Threading_Timer::Change___BOOLEAN__I4__I4,
    Library_CorLib_System_Threading_Timer::Change___BOOLEAN__SystemTimeSpan__SystemTimeSpan,
    NULL,
    NULL,
    NULL,
    NULL,
    Library_CorLib_System_Threading_WaitHandle::WaitOne___BOOLEAN__I4__BOOLEAN,
    NULL,
    NULL,
    Library_CorLib_System_Threading_WaitHandle::WaitMultiple___STATIC__I4__SZARRAY_SystemThreadingWaitHandle__I4__BOOLEAN__BOOLEAN,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_ValueType::Equals___BOOLEAN__OBJECT,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_CorLib_System_WeakReference::get_IsAlive___BOOLEAN,
    Library_CorLib_System_WeakReference::get_Target___OBJECT,
    Library_CorLib_System_WeakReference::set_Target___VOID__OBJECT,
    Library_CorLib_System_WeakReference::_ctor___VOID__OBJECT,
};
