...
HRESULT Library_corlib_native_System_Array::System_Collections_IList_set_Item___VOID__I4__OBJECT(
    ...
    CLR_RT_StackFrame &stack)
{
    ...
    NANOCLR_CHECK_HRESULT(
        CLR_RT_HeapBlock_Array::CreateInstance(stack.PushValue(), stack.Arg1().NumericByRefConst().s4, td));
    ...
    CLR_RT_StackFrame &stack)
{
    ...
    NANOCLR_SET_AND_LEAVE(Copy(
        stack,
        stack.Arg0(),
        stack.Arg1().NumericByRef().s4,
        stack.Arg2(),
        stack.Arg3().NumericByRef().s4,
        stack.Arg4().NumericByRef().s4));
...
HRESULT Library_corlib_native_System_Array::Clear(
    CLR_RT_StackFrame &stack,
    ...
    int length)
{
    ...
    if (length < 0 || index < 0 || length + index > numElem)
    {
...
HRESULT Library_corlib_native_System_Array::Copy(
    CLR_RT_StackFrame &stack,
    ...
    int length)
{
    ...
    if (length)
    {
        ...
        NANOCLR_SET_AND_LEAVE(CLR_RT_HeapBlock_Array::Copy(
            argSrc.DereferenceArray(),
            indexSrc,
            argDst.DereferenceArray(),
            indexDst,
            length));
    }
...
HRESULT Library_corlib_native_System_Array::TrySzIndexOf(
    CLR_RT_StackFrame &stack,
    CLR_RT_HeapBlock &argSrc,
