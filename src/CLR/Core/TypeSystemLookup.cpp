...
#define DT_DIRCT CLR_RT_DataTypeLookup::c_Direct
#define DT_OPT   CLR_RT_DataTypeLookup::c_OptimizedValueType
#define DT_MT    CLR_RT_DataTypeLookup::c_ManagedType

#define DT_VAR   CLR_RT_DataTypeLookup::c_Var
#define DT_GENER CLR_RT_DataTypeLookup::c_GenericInstance
#define DT_MVAR  CLR_RT_DataTypeLookup::c_MVar
...
#define DATATYPE_NOT_SUPPORTED { DT_NA, DT_NA, DT_NA, DT_T(FIRST_INVALID), DT_CNV(END), nullptr, DT_NOREL(CLR_RT_HeapBlock) DT_OPT_NAME(NOT_SUPPORTED) },

const CLR_RT_DataTypeLookup c_CLR_RT_DataTypeLookup[] =
{
////  flags, sizeInBits, sizeInBytes, promoteTo, convertToElementType, cls, relocate, name
////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(VOID                ), DT_CNV(VOID      ), nullptr                     , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(VOID                ) }, // DATATYPE_VOID
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     1, DT_U1, DT_T(I4                  ), DT_CNV(BOOLEAN    ), DT_CLS(Boolean            ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(BOOLEAN             ) }, // DATATYPE_BOOLEAN
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     8, DT_I1, DT_T(I4                  ), DT_CNV(I1         ), DT_CLS(Int8               ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I1                  ) }, // DATATYPE_I1
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     8, DT_U1, DT_T(I4                  ), DT_CNV(U1         ), DT_CLS(UInt8              ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U1                  ) }, // DATATYPE_U1
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_U2, DT_T(I4                  ), DT_CNV(CHAR       ), DT_CLS(Char               ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(char                ) }, // DATATYPE_CHAR
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_I2, DT_T(I4                  ), DT_CNV(I2         ), DT_CLS(Int16              ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I2                  ) }, // DATATYPE_I2
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_U2, DT_T(I4                  ), DT_CNV(U2         ), DT_CLS(UInt16             ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U2                  ) }, // DATATYPE_U2
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_I4, DT_T(I4                  ), DT_CNV(I4         ), DT_CLS(Int32              ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I4                  ) }, // DATATYPE_I4
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_U4, DT_T(I4                  ), DT_CNV(U4         ), DT_CLS(UInt32             ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U4                  ) }, // DATATYPE_U4
    { DT_NUM |          DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_I4, DT_T(R4                  ), DT_CNV(R4         ), DT_CLS(Single             ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(R4                  ) }, // DATATYPE_R4
                                                                                                                                                                                                                                                                   //
    ...
    {          DT_INT | DT_SGN | DT_VALUE            | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_BL, DT_T(DATETIME            ), DT_CNV(END        ), DT_CLS(DateTime           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(DATETIME            ) }, // DATATYPE_DATETIME
    {          DT_INT | DT_SGN | DT_VALUE            | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_BL, DT_T(TIMESPAN            ), DT_CNV(END        ), DT_CLS(TimeSpan           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(TIMESPAN            ) }, // DATATYPE_TIMESPAN
    ...
    { DT_REF                   | DT_CLASS                                | DT_MT           , DT_NA, DT_BL, DT_T(CLASS               ), DT_CNV(CLASS      ), nullptr                    , DT_REL  (CLR_RT_HeapBlock              ::Relocate_Cls     ) DT_OPT_NAME(CLASS               ) }, // DATATYPE_CLASS
    { DT_REF                   | DT_VALUE                                | DT_MT           , DT_NA, DT_BL, DT_T(VALUETYPE           ), DT_CNV(VALUETYPE  ), nullptr                    , DT_REL  (CLR_RT_HeapBlock              ::Relocate_Cls     ) DT_OPT_NAME(VALUETYPE           ) }, // DATATYPE_VALUETYPE
    { DT_REF                   | DT_CLASS | DT_ARRAY                     | DT_MT           , DT_NA, DT_BL, DT_T(SZARRAY             ), DT_CNV(SZARRAY    ), DT_CLS(Array              ), DT_REL  (CLR_RT_HeapBlock_Array        ::Relocate         ) DT_OPT_NAME(SZARRAY             ) }, // DATATYPE_SZARRAY
    { DT_REF                                                             | DT_MT           , DT_NA, DT_NA, DT_T(BYREF               ), DT_CNV(BYREF      ), nullptr                    , DT_REL  (CLR_RT_HeapBlock              ::Relocate_Ref     ) DT_OPT_NAME(BYREF               ) }, // DATATYPE_BYREF

    {                                                                      DT_MT | DT_VAR  , DT_NA, DT_BL, DT_T(VAR                 ), DT_CNV(VAR        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(VAR                 ) }, // DATATYPE_VAR
    {                                                                      DT_MT | DT_GENER, DT_NA, DT_BL, DT_T(GENERICINST         ), DT_CNV(GENERICINST), nullptr                    , DT_REL  (CLR_RT_HeapBlock              ::Relocate_Cls     ) DT_OPT_NAME(GENERICINST         ) }, // DATATYPE_GENERICINST
    {                                                                      DT_MT | DT_MVAR , DT_NA, DT_BL, DT_T(MVAR                ), DT_CNV(MVAR       ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(MVAR                ) }, // DATATYPE_MVAR

    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(FREEBLOCK           ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(FREEBLOCK           ) }, // DATATYPE_FREEBLOCK
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(CACHEDBLOCK         ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock_Node                            ) DT_OPT_NAME(CACHEDBLOCK         ) }, // DATATYPE_CACHEDBLOCK
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(ASSEMBLY            ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_Assembly               ::Relocate         ) DT_OPT_NAME(ASSEMBLY            ) }, // DATATYPE_ASSEMBLY
    { DT_REF                                                             | DT_MT           , DT_NA, DT_BL, DT_T(WEAKCLASS           ), DT_CNV(END        ), DT_CLS(WeakReference      ), DT_REL  (CLR_RT_HeapBlock_WeakReference::Relocate         ) DT_OPT_NAME(WEAKCLASS           ) }, // DATATYPE_WEAKCLASS
    {                                                                      DT_MT           , DT_NA, DT_NA, DT_T(REFLECTION          ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(REFLECTION          ) }, // DATATYPE_REFLECTION
    {                                                                      DT_MT           , DT_NA, DT_NA, DT_T(ARRAY_BYREF         ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock              ::Relocate_ArrayRef) DT_OPT_NAME(ARRAY_BYREF         ) }, // DATATYPE_ARRAY_BYREF
    { DT_REF                                                             | DT_MT           , DT_NA, DT_BL, DT_T(DELEGATE_HEAD       ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_Delegate     ::Relocate         ) DT_OPT_NAME(DELEGATE_HEAD       ) }, // DATATYPE_DELEGATE_HEAD
    { DT_REF                                                             | DT_MT           , DT_NA, DT_NA, DT_T(DELEGATELIST_HEAD   ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_Delegate_List::Relocate         ) DT_OPT_NAME(DELEGATELIST_HEAD   ) }, // DATATYPE_DELEGATELIST_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(OBJECT_TO_EVENT     ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_ObjectToEvent_Source   ::Relocate         ) DT_OPT_NAME(OBJECT_TO_EVENT     ) }, // DATATYPE_OBJECT_TO_EVENT
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(BINARY_BLOB_HEAD    ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_BinaryBlob   ::Relocate         ) DT_OPT_NAME(BINARY_BLOB_HEAD    ) }, // DATATYPE_BINARY_BLOB_HEAD
                                                                                                                                                                                                                                                                   //
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(THREAD              ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_Thread                 ::Relocate         ) DT_OPT_NAME(THREAD              ) }, // DATATYPE_THREAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(SUBTHREAD           ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_SubThread              ::Relocate         ) DT_OPT_NAME(SUBTHREAD           ) }, // DATATYPE_SUBTHREAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(STACK_FRAME         ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_StackFrame             ::Relocate         ) DT_OPT_NAME(STACK_FRAME         ) }, // DATATYPE_STACK_FRAME
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(TIMER_HEAD          ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock_Timer                           ) DT_OPT_NAME(TIMER_HEAD          ) }, // DATATYPE_TIMER_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(LOCK_HEAD           ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_Lock         ::Relocate         ) DT_OPT_NAME(LOCK_HEAD           ) }, // DATATYPE_LOCK_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(LOCK_OWNER_HEAD     ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_Lock         ::Relocate_Owner   ) DT_OPT_NAME(LOCK_OWNER_HEAD     ) }, // DATATYPE_LOCK_OWNER_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(LOCK_REQUEST_HEAD   ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_LockRequest  ::Relocate         ) DT_OPT_NAME(LOCK_REQUEST_HEAD   ) }, // DATATYPE_LOCK_REQUEST_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(WAIT_FOR_OBJECT_HEAD), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_WaitForObject::Relocate         ) DT_OPT_NAME(WAIT_FOR_OBJECT_HEAD) }, // DATATYPE_WAIT_FOR_OBJECT_HEAD
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(FINALIZER_HEAD      ), DT_CNV(END        ), nullptr                    , DT_REL  (CLR_RT_HeapBlock_Finalizer    ::Relocate         ) DT_OPT_NAME(FINALIZER_HEAD      ) }, // DATATYPE_FINALIZER_HEAD
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(MEMORY_STREAM_HEAD  ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock_MemoryStream                    ) DT_OPT_NAME(MEMORY_STREAM_HEAD  ) }, // DATATYPE_MEMORY_STREAM_HEAD
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(MEMORY_STREAM_DATA  ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock_MemoryStream                    ) DT_OPT_NAME(MEMORY_STREAM_DATA  ) }, // DATATYPE_MEMORY_STREAM_DATA
                                                                                                                                                                                                                                                                   //
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(SERIALIZER_HEAD     ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_BinaryFormatter                           ) DT_OPT_NAME(SERIALIZER_HEAD     ) }, // DATATYPE_SERIALIZER_HEAD
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(SERIALIZER_DUPLICATE), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_BinaryFormatter                           ) DT_OPT_NAME(SERIALIZER_DUPLICATE) }, // DATATYPE_SERIALIZER_DUPLICATE
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(SERIALIZER_STATE    ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_BinaryFormatter                           ) DT_OPT_NAME(SERIALIZER_STATE    ) }, // DATATYPE_SERIALIZER_STATE
                                                                                                                                                                                                                                                                   //
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(ENDPOINT_HEAD       ), DT_CNV(END        ), nullptr                    , DT_NOREL(CLR_RT_HeapBlock_EndPoint                        ) DT_OPT_NAME(ENDPOINT_HEAD       ) }, // DATATYPE_ENDPOINT_HEAD
                                                                                                                                                                                                                                                                   //
    DATATYPE_NOT_SUPPORTED
    DATATYPE_NOT_SUPPORTED
    DATATYPE_NOT_SUPPORTED

    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(IO_PORT             ), DT_CNV(END      ), nullptr                      , DT_NOREL(CLR_RT_HeapBlock_NativeEventDispatcher                          ) DT_OPT_NAME(IO_PORT             ) }, // DATATYPE_IO_PORT

    DATATYPE_NOT_SUPPORTED  //VTU_PORT

#if defined(NANOCLR_APPDOMAINS)
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(APPDOMAIN_HEAD      ), DT_CNV(END      ), nullptr                      , DT_REL  (CLR_RT_AppDomain::Relocate                       ) DT_OPT_NAME(APPDOMAIN_HEAD      ) }, // DATATYPE_APPDOMAIN_HEAD
    { DT_REF                                                           | DT_MT             , DT_NA, DT_NA, DT_T(TRANSPARENT_PROXY   ), DT_CNV(END      ), nullptr                      , DT_REL  (CLR_RT_HeapBlock::Relocate_TransparentProxy      ) DT_OPT_NAME(TRANSPARENT_PROXY   ) }, // DATATYPE_TRANSPARENT_PROXY
    { DT_REF                                                                               , DT_NA, DT_NA, DT_T(APPDOMAIN_ASSEMBLY  ), DT_CNV(END      ), nullptr                      , DT_REL  (CLR_RT_AppDomainAssembly::Relocate               ) DT_OPT_NAME(APPDOMAIN_ASSEMBLY  ) }, // DATATYPE_APPDOMAIN_ASSEMBLY
#else
    DATATYPE_NOT_SUPPORTED
    DATATYPE_NOT_SUPPORTED
    DATATYPE_NOT_SUPPORTED
