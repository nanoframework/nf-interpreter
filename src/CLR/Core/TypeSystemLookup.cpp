...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    { DT_REF                   | DT_VALUE                              | DT_MT, DT_NA, DT_BL, DT_T(DATETIME            ), DT_CNV(VALUETYPE), DT_CLS(m_DateTime         ), DT_NOREL(CLR_RT_HeapBlock              ::Relocate_Cls     ) DT_OPT_NAME(DATETIME            ) }, // DATATYPE_DATETIME
    { DT_REF                   | DT_VALUE                              | DT_MT, DT_NA, DT_BL, DT_T(TIMESPAN            ), DT_CNV(VALUETYPE), DT_CLS(m_TimeSpan         ), DT_NOREL(CLR_RT_HeapBlock              ::Relocate_Cls     ) DT_OPT_NAME(TIMESPAN            ) }, // DATATYPE_TIMESPAN
