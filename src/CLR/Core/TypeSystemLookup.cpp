...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    { DT_NA                                                                                , DT_NA, DT_NA, DT_T(VOID                ), DT_CNV(VOID      ), NULL                       , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(VOID                ) }, // DATATYPE_VOID
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     1, DT_U1, DT_T(I4                  ), DT_CNV(BOOLEAN    ), DT_CLS(m_Boolean          ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(BOOLEAN             ) }, // DATATYPE_BOOLEAN
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     8, DT_I1, DT_T(I4                  ), DT_CNV(I1         ), DT_CLS(m_Int8             ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I1                  ) }, // DATATYPE_I1
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,     8, DT_U1, DT_T(I4                  ), DT_CNV(U1         ), DT_CLS(m_UInt8            ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U1                  ) }, // DATATYPE_U1
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_U2, DT_T(I4                  ), DT_CNV(CHAR       ), DT_CLS(m_Char             ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(char                ) }, // DATATYPE_CHAR
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_I2, DT_T(I4                  ), DT_CNV(I2         ), DT_CLS(m_Int16            ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I2                  ) }, // DATATYPE_I2
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    16, DT_U2, DT_T(I4                  ), DT_CNV(U2         ), DT_CLS(m_UInt16           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U2                  ) }, // DATATYPE_U2
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_I4, DT_T(I4                  ), DT_CNV(I4         ), DT_CLS(m_Int32            ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I4                  ) }, // DATATYPE_I4
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_U4, DT_T(I4                  ), DT_CNV(U4         ), DT_CLS(m_UInt32           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U4                  ) }, // DATATYPE_U4
    { DT_NUM |          DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    32, DT_I4, DT_T(R4                  ), DT_CNV(R4         ), DT_CLS(m_Single           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(R4                  ) }, // DATATYPE_R4
                                                                                                                                                                                                                                                                   //
    { DT_NUM | DT_INT | DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_I8, DT_T(I8                  ), DT_CNV(I8         ), DT_CLS(m_Int64            ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(I8                  ) }, // DATATYPE_I8
    { DT_NUM | DT_INT          | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_U8, DT_T(I8                  ), DT_CNV(U8         ), DT_CLS(m_UInt64           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(U8                  ) }, // DATATYPE_U8
    { DT_NUM |          DT_SGN | DT_PRIM             | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_I8, DT_T(R8                  ), DT_CNV(R8         ), DT_CLS(m_Double           ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(R8                  ) }, // DATATYPE_R8
    {          DT_INT | DT_SGN | DT_VALUE            | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_BL, DT_T(DATETIME            ), DT_CNV(END        ), DT_CLS(m_DateTime         ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(DATETIME            ) }, // DATATYPE_DATETIME
    {          DT_INT | DT_SGN | DT_VALUE            | DT_DIRCT | DT_OPT | DT_MT           ,    64, DT_BL, DT_T(TIMESPAN            ), DT_CNV(END        ), DT_CLS(m_TimeSpan         ), DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(TIMESPAN            ) }, // DATATYPE_TIMESPAN
    { DT_REF                   | DT_PRIM             | DT_DIRCT          | DT_MT           , DT_VS, DT_BL, DT_T(STRING              ), DT_CNV(STRING     ), DT_CLS(m_String           ), DT_REL  (CLR_RT_HeapBlock              ::Relocate_String  ) DT_OPT_NAME(STRING              ) }, // DATATYPE_STRING
                                                                                                                                                                                                                                                                   //
    { DT_REF                                         | DT_DIRCT          | DT_MT           , DT_NA, DT_BL, DT_T(OBJECT              ), DT_CNV(OBJECT     ), DT_CLS(m_Object           ), DT_REL  (CLR_RT_HeapBlock              ::Relocate_Obj     ) DT_OPT_NAME(OBJECT              ) }, // DATATYPE_OBJECT
    ...
    {                                                                      DT_MT | DT_VAR  , DT_NA, DT_BL, DT_T(VAR                 ), DT_CNV(VAR        ), NULL                       , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(VAR                 ) }, // DATATYPE_VAR
    {                                                                      DT_MT | DT_GENER, DT_NA, DT_BL, DT_T(GENERICINST         ), DT_CNV(GENERICINST), NULL                       , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(GENERICINST         ) }, // DATATYPE_GENERICINST
    {                                                                      DT_MT | DT_MVAR , DT_NA, DT_BL, DT_T(MVAR                ), DT_CNV(MVAR       ), NULL                       , DT_NOREL(CLR_RT_HeapBlock                                 ) DT_OPT_NAME(MVAR                ) }, // DATATYPE_MVAR
