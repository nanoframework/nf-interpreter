...
CLR_RT_HeapBlock *CLR_RT_HeapBlock_Delegate_List::CopyAndCompress(
...
HRESULT CLR_RT_HeapBlock_Delegate_List::Change(
    ...
    bool fWeak)
{
    ...
    else
    {
        ...
        if (fWeak)
            dlgListDst->m_flags |= CLR_RT_HeapBlock_Delegate_List::c_Weak;
...
HRESULT CLR_RT_HeapBlock_Delegate_List::Combine(
    CLR_RT_HeapBlock &reference,
    CLR_RT_HeapBlock &delegateSrc,
...
HRESULT CLR_RT_HeapBlock_Delegate_List::Remove(
    CLR_RT_HeapBlock &reference,
    CLR_RT_HeapBlock &delegateSrc,
    CLR_RT_HeapBlock &delegateOld)
{
    NATIVE_PROFILE_CLR_CORE();
    NANOCLR_HEADER();
