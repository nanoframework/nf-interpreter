...
/**
 * @file corhdr_private.h
 * @brief !!!! Lifted verbatim from corhdr.h !!!!! https://github.com/dotnet/coreclr/blob/master/src/inc/corhdr.h
 * @ingroup CLR_Core
 */
...
/**
 * @defgroup nanoFramework interpreter Private
 * @ingroup nanoFramework
 * @brief Corhdr interface.
 * 
 * @{
 */

/**
 * @brief Element type for Cor signature
 */
...
/**
 * @brief Serialization types for Custom attribute support
 */
