...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<unsigned char>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<unsigned short>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<unsigned int>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<unsigned __int64>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<char>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<signed char>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<signed short>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<signed int>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<signed __int64>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<float>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
{
    NATIVE_PROFILE_CLR_CORE();
    return Interop_Marshal_NUMERIC_ARRAY<double>(
        stackFrame,
        paramIndex,
        typedArray.m_pData,
        typedArray.m_ElemCount,
...
**
** Arguments: [stackFrame]           - Reference to the managed stack frame.
**            [pHeapBlock]           - Pointer to heap block that keeps reference type extracted from managed stack
*frame
...
**
** Returns:   S_OK on success or error from LoadFromReference of CLR_E_WRONG_TYPE if type invalid. Error return would
*cause exception thrown in managed code.
**********************************************************************/
