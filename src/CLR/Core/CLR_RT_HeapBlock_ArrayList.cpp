...
CT_ASSERT(
    Library_corlib_native_System_Collections_ArrayList__FIELD___items ==
    Library_corlib_native_System_Collections_ArrayList::FIELD___items);
CT_ASSERT(
    Library_corlib_native_System_Collections_ArrayList__FIELD___size ==
    Library_corlib_native_System_Collections_ArrayList::FIELD___size);
