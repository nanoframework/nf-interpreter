...
# Add packages that are common to ThreadX platform builds
    ...
    if(NFAPP_TARGET STREQUAL ${NANOCLR_PROJECT_NAME})
        ...
        if(THREADX_NETXDUO_REQUIRED)
            ...
            if("${TARGET_SERIES}" STREQUAL "STM32F7xx")
                set(TX_PORT_FILE ${threadx_SOURCE_DIR}/ports/cortex_m7/gnu/inc/tx_port.h)
            elseif("${TARGET_SERIES}" STREQUAL "STM32L4xx"
                    OR "${TARGET_SERIES}" STREQUAL "EFM32GG11")
                set(TX_PORT_FILE ${threadx_SOURCE_DIR}/ports/cortex_m4/gnu/inc/tx_port.h)
            else()
...
# Add ThreadX platform dependencies to a specific CMake target
# To be called from target CMakeList.txt
...
# Add ThreadX platform include directories to a specific CMake target
# To be called from target CMakeList.txt
...
# Add ThreadX platform target sources to a specific CMake target
# To be called from target CMakeList.txt
