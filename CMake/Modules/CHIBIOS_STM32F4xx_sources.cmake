...
foreach(SRC_FILE ${CHIBIOS_PORT_SRCS})
    ...
    find_file(CHIBIOS_F4_SRC_FILE ${SRC_FILE}
        PATHS 
            ...
            if(${CHIBIOS_BOARD} STREQUAL "ST_STM32F429I_DISCOVERY" OR ${CHIBIOS_BOARD} STREQUAL "ST_STM32F4_DISCOVERY" OR ${CHIBIOS_BOARD} STREQUAL "MBN_QUAIL" OR ${CHIBIOS_BOARD} STREQUAL "NETDUINO3_WIFI")
