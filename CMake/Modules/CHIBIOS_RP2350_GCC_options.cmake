...
# RP2350: ARM Cortex-M33 (ARMv8-M Mainline)

# need to specify this for assembler
set(CMAKE_ASM_FLAGS " -mthumb -mcpu=cortex-m33 -mfloat-abi=softfp -mfpu=fpv5-sp-d16 -mabi=aapcs -x assembler-with-cpp -DCRT0_VTOR_INIT=TRUE -DCRT0_EXTRA_CORES_NUMBER=0" CACHE INTERNAL "asm compiler flags")

# need to specify linker flags here
set(CMAKE_EXE_LINKER_FLAGS " -Wl,--gc-sections -Wl,--no-wchar-size-warning -Wl,--print-memory-usage -Wl,--no-warn-rwx-segments -mthumb -mcpu=cortex-m33 -mfloat-abi=softfp -mfpu=fpv5-sp-d16 -mabi=aapcs -nostartfiles " CACHE INTERNAL "executable linker flags")
