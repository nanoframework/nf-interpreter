...
if(API_Hardware.Esp32)
    if(API_Hardware.Stm32)
        message( SEND_ERROR "API_Hardware.Stm32 is incompatible" )
    endif()
    if(API_nanoFramework.TI.EasyLink)
        message( SEND_ERROR "API_nanoFramework.TI.EasyLink is incompatible" )
    endif()
    if(API_nanoFramework.Hardware.TI)
        message( SEND_ERROR "API_nanoFramework.Hardware.TI is incompatible" )
    endif()
...
if(API_Hardware.Stm32)
    if(API_Hardware.Esp32)
        message( SEND_ERROR "API_Hardware.Esp32 is incompatible" )
    endif()
    if(API_nanoFramework.Hardware.Esp32.Rmt)
        message( SEND_ERROR "API_nanoFramework.Hardware.Esp32.Rmt is incompatible" )
    endif()
    if(API_nanoFramework.TI.EasyLink)
        message( SEND_ERROR "API_nanoFramework.TI.EasyLink is incompatible" )
    endif()
