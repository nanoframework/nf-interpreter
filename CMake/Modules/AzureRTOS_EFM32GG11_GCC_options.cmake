...
set(CMAKE_EXE_LINKER_FLAGS " -Wl,--gc-sections -Wl,--no-wchar-size-warning -Wl,--print-memory-usage -Wl,--no-warn-rwx-segments -gdwarf-2 -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mabi=aapcs " CACHE INTERNAL "executable linker flags")
...
macro(nf_set_compile_options)
    ...
    if(GECKO_DEVICE_CLASS_VENDOR_DESCRIPTION_LENGTH)
        target_compile_definitions(${NFSCO_TARGET} PUBLIC -DGECKO_DEVICE_CLASS_VENDOR_DESCRIPTION_PROPERTY_LEN=${GECKO_DEVICE_CLASS_VENDOR_DESCRIPTION_LENGTH} )
    else()
        target_compile_definitions(${NFSCO_TARGET} PUBLIC -DGECKO_DEVICE_CLASS_VENDOR_DESCRIPTION_PROPERTY_LEN=64 )
    endif()
