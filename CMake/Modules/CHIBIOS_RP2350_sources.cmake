...
# List of the ChibiOS generic RP2350 startup source files.
# RP2350 uses ARM Cortex-M33 (ARMv8-M Mainline).

set(CHIBIOS_PORT_SRCS

    # RT port for ARMv8-M Mainline
    chcore.c
    chcoreasm.S
)
...
foreach(SRC_FILE ${CHIBIOS_PORT_SRCS})
    ...
    find_file(CHIBIOS_RP_SRC_FILE ${SRC_FILE}
        PATHS
            ...
            ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT
