...
# set include directories for ChibiOS HAL (RP2350)
...
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/hal/ports/RP/RP2350)
...
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT/smp/rp2)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT/compilers/GCC)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/startup/ARMCMx/compilers/GCC)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/startup/ARMCMx/devices/RP2350)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ext/ARM/CMSIS/Core/Include)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ext/RP)
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/common/ext/RP/RP2350)

# RP LLD (Low Level Driver) include directories
...
list(APPEND CHIBIOS_HAL_INCLUDE_DIRS ${chibios_SOURCE_DIR}/os/hal/ports/RP/LLD/RTCv2)
...
# source files for ChibiOS HAL (RP2350)
set(CHIBIOS_HAL_SRCS
    ...
    # RP2350 platform-specific ISR and clock init
    hal_lld.c
    rp_clocks.c
    rp_isr.c
    rp_pll.c
    ...
    # RP LLD (Low Level Driver) sources
    hal_adc_lld.c
    rp_dma.c
    hal_pal_lld.c
    hal_i2c_lld.c
...
foreach(SRC_FILE ${CHIBIOS_HAL_SRCS})
    ...
    find_file(CHIBIOS_HAL_SRC_FILE ${SRC_FILE}
        PATHS
            ...
            ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT/compilers/GCC
            ${chibios_SOURCE_DIR}/os/common/ports/ARMv8-M-ML-ALT/smp/rp2
            ${chibios_SOURCE_DIR}/os/common/startup/ARMCMx/compilers/GCC
            ${chibios_SOURCE_DIR}/os/common/startup/ARMCMx/devices/RP2350
            ...
            ${chibios_SOURCE_DIR}/os/hal/ports/RP/RP2350
            ...
            ${chibios_SOURCE_DIR}/os/hal/ports/RP/LLD/RTCv2
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ChibiOS_RP2350_HAL DEFAULT_MSG CHIBIOS_HAL_INCLUDE_DIRS CHIBIOS_HAL_SOURCES)
