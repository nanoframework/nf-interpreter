...
foreach(SRC_FILE ${CHIBIOS_PORT_SRCS})
    ...
    find_file(CHIBIOS_L0_SRC_FILE ${SRC_FILE}
        PATHS 
            ...
            ${PROJECT_BINARY_DIR}/ChibiOS_Source/os/hal/ports/STM32/LLD/EXTv1
...
list(APPEND CHIBIOS_INCLUDE_DIRS ${PROJECT_BINARY_DIR}/ChibiOS_Source/os/common/ext/CMSIS/ST/STM32L0xx)
list(APPEND CHIBIOS_INCLUDE_DIRS ${PROJECT_BINARY_DIR}/ChibiOS_Source/os/hal/ports/STM32/STM32L0xx)
