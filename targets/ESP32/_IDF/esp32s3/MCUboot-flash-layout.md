# MCUboot Flash Layout — esp32s3 (Xtensa LX7, WiFi + BT LE)
...
| `partitions_nanoclr_mcuboot_32mb.csv` | 32 MB | swap-using-move | 2× 1664k  | 32k         | 24k    | ~28.6 MB |
...
Same structure as 8 MB; deploy size extends to ~12.6 MB (16MB) or ~28.6 MB (32MB).
