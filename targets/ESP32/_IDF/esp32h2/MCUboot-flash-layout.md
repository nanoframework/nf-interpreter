...
|--------------------------------------|-------|-----------------|-----------|-------------|--------|-----------------|
| `partitions_nanoclr_mcuboot_4mb.csv` | 4 MB  | swap-using-move | 2× 1728k  | —           | 24k    | 244k            |

> No swap_status partition on 4 MB — flash budget is tight (only 488k total for deployment; split 244k each).
...
| deploy_0    | data | 0x84     | 0x386000  | 244k   |
| deploy_1    | data | 0x84     | 0x3C3000  | 244k   |
