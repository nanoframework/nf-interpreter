...
static rmt_sync_manager_handle_t s_syncManagerHandle = nullptr;
    ...
    NativeCreateSyncManager___VOID__SZARRAY_I4(CLR_RT_StackFrame &stack)
{
    ...
    CLR_RT_HeapBlock_Array *transmitChannelArray = nullptr;
    ...
    if (s_syncManagerHandle != nullptr)
    {
