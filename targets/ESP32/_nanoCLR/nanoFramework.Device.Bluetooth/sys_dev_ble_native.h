...
{
    static const int FIELD___localChar = 1;
    static const int FIELD___eventID = 2;
...
struct Library_sys_dev_ble_native_nanoFramework_Device_Bluetooth_GenericAttributeProfile_GattLocalCharacteristic
{
    ...
    static const int FIELD___parameters = 3;
...
struct Library_sys_dev_ble_native_nanoFramework_Device_Bluetooth_DataReader
{
    ...
    static const int FIELD___currentReadPosition = 3;

    //--//
};

struct Library_sys_dev_ble_native_nanoFramework_Device_Bluetooth_DataWriter
{
...
struct Library_sys_dev_ble_native_nanoFramework_Device_Bluetooth_GenericAttributeProfile_GattDescriptorUuids
{
    static const int FIELD_STATIC__BaseGuid = 3;
...
{
    static const int FIELD_STATIC__GitCommitDate = 5;
