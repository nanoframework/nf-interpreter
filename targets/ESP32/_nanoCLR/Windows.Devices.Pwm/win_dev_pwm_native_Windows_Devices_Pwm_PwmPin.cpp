...
HRESULT ConfigureAndStart(CLR_RT_HeapBlock *pThis, bool create, bool noStart)
{
    NANOCLR_HEADER();
    {
        ...
        int timerId = (int)(pThis[Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::
                                      Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::FIELD___pwmTimer]
                                .NumericByRef()
                                .u4);
        int pinNumber =
            (int)(pThis[Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::FIELD___pinNumber].NumericByRef().u4);
        uint32_t dutyCycle = (uint32_t)(pThis[Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::FIELD___dutyCycle]
                                            .NumericByRef()
                                            .u4);
        PwmPulsePolarity polarity =
            (PwmPulsePolarity)(pThis[Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::FIELD___polarity]
                                   .NumericByRef()
                                   .u4);
...
HRESULT Library_win_dev_pwm_native_Windows_Devices_Pwm_PwmPin::NativeSetActiveDutyCyclePercentage___VOID__U4(
