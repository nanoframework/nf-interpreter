...
struct gpio_input_state : public HAL_DblLinkedNode<gpio_input_state>
{
    ...
    // struct k_timer debounceTimer;        // debounce timer for this Pin
...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
    // gpio_input_state *pState = CONTAINER_OF(timer, struct gpio_input_state, debounceTimer);
...
void CPU_GPIO_DisablePin(GPIO_PIN pinNumber, GpioPinDriveMode driveMode, uint32_t alternateFunction)
{
    ...
    // (db) Very strange to 'disable' a pin but put it into some random drive mode.
