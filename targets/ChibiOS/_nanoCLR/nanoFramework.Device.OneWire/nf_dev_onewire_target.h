...
#define UART_CONFIG_PINS(num, gpio_port_tx, tx_pin, alternate_function)                                                \
    void ConfigPins_UART##num()                                                                                        \
    {                                                                                                                  \
        palSetPadMode(                                                                                                 \
            gpio_port_tx,                                                                                              \
            tx_pin,                                                                                                    \
            PAL_MODE_ALTERNATE(alternate_function) | PAL_STM32_OTYPE_OPENDRAIN | PAL_MODE_INPUT_PULLUP |               \
