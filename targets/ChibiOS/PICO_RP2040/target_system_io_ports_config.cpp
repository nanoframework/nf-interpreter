...
// Default RP2040 COM1 pin configuration:
// TX = GP0
// RX = GP1
...
// initialization for UART1 (mapped to RP2040 UART0)
UART_INIT(1)

// un-initialization for UART1 (mapped to RP2040 UART0)
UART_UNINIT(1)
...
// Default RP2040 COM2 pin configuration:
// TX = GP8
// RX = GP9
...
// initialization for UART2 (mapped to RP2040 UART1)
UART_INIT(2)

// un-initialization for UART2 (mapped to RP2040 UART1)
UART_UNINIT(2)