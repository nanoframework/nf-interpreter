...
UART_CONFIG_PINS__(5, GPIOD, GPIOC, 2, 12, 8)
...
__attribute__((aligned(32)))
#endif
uint8_t Uart5_TxBuffer__[UART5_TX_SIZE];

#if defined(__GNUC__)
__attribute__((aligned(32)))
#endif
uint8_t Uart5_RxBuffer__[UART5_RX_SIZE];

// initialization for UART5
UART_INIT__(5, UART5_TX_SIZE, UART5_RX_SIZE)
