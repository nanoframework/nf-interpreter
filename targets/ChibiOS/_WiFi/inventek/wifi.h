...
typedef enum {
  ...
  // remote peer closed the connection in an orderly way (distinct from WIFI_STATUS_ERROR, which
  // means a genuine I/O failure) - see WIFI_ReceiveData()
  WIFI_STATUS_SOCKET_CLOSED  = 6,
}WIFI_Status_t;
