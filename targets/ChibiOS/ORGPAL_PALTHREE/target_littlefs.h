...
#define LFS0_BLOCK_COUNT 1000//AT25SF641_FLASH_SIZE/AT25SF641_PAGE_SIZE
...
#define LFS1_BLOCK_SIZE 1
#define LFS1_BLOCK_COUNT 1
// #define LFS1_BLOCK_CYCLES
// #define LFS1_CACHE_SIZE
// #define LFS1_LOOKAHEAD_SIZE

#define LFS1_READ_HANDLER hal_lfs_read
#define LFS1_PROG_HANDLER hal_lfs_prog
#define LFS1_ERASE_HANDLER hal_lfs_erase
...
extern "C"
{
    ...
    int32_t hal_lfs_prog_0(const struct lfs_config *c, lfs_block_t block, lfs_off_t off, const void *buffer, lfs_size_t size);
