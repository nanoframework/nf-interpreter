    ...
    bool done)
{
    ...
    else if (configuration == DeviceConfigurationOption_X509CaRootBundle)
    {
             ...
             (configurationIndex + 1) > g_TargetConfiguration.CertificateStore->Count))
        {
            ...
            if (!g_ConfigFlashDriver.IsBlockErased(nullptr, storageAddress, blockSize))
            {
    ...
    success = g_ConfigFlashDriver.Write(nullptr, storageAddress, blockSize, (unsigned char *)configurationBlock, true);
