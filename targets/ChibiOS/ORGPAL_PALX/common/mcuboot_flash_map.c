...
static const struct flash_area s_flash_areas[] = {
    ...
    { .fa_id = FLASH_AREA_IMAGE_0_PRIMARY,   .fa_device_id = FLASH_DEVICE_INTERNAL_FLASH, .fa_off = 0x08010000U, .fa_size = (704U  * 1024U) },
    { .fa_id = FLASH_AREA_IMAGE_0_SECONDARY, .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH, .fa_off = 0x000000U,   .fa_size = (704U  * 1024U) },
    { .fa_id = FLASH_AREA_IMAGE_1_PRIMARY,   .fa_device_id = FLASH_DEVICE_INTERNAL_FLASH, .fa_off = 0x080C0000U, .fa_size = (1280U * 1024U) },
    { .fa_id = FLASH_AREA_IMAGE_1_SECONDARY, .fa_device_id = FLASH_DEVICE_EXTERNAL_FLASH, .fa_off = 0x0B0000U,   .fa_size = (1280U * 1024U) },
    // clang-format on
};
...
static_assert(0x08010000U + (704U  * 1024U) <= 0x080C0000U, "CLR primary overflows into deploy primary");
static_assert(0x000000U   + (704U  * 1024U) <= 0x0B0000U,   "CLR secondary overflows into deploy secondary");
static_assert((1280U * 1024U) / MCUBOOT_EXTERNAL_FLASH_SECTOR_SIZE <= MCUBOOT_MAX_IMG_SECTORS,
