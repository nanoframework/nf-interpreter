...
/**
 * @file    mcuconf.h
 * @brief   MCU hardware configuration for the MCUboot bootloader on ORGPAL_PALX.
 *
 * Derived from targets/ChibiOS/ORGPAL_PALX/nanoBooter/mcuconf.h.
 * Only the settings needed by the MCUboot bootloader are kept:
 *   - Full PLL from HSE (12 MHz → 216 MHz SYSCLK), identical to nanoBooter.
 *   - QUADSPI1 (WSPI) enabled for W25Q512 external flash.
...
/*===========================================================================*/
/* IRQ priorities (keep defaults — only EXTI/WSPI relevant at boot).         */
/*===========================================================================*/
...
/*===========================================================================*/
/* WSPI (QUADSPI) — enabled for W25Q512 external flash.                      */
/* Prescaler=2 → QSPI_CLK = 216 MHz / 3 = 72 MHz.                          */
/* DMA: DMA2 Stream 7.                                                       */
/*===========================================================================*/
