...
#if (HAL_USE_SDC == TRUE) && (defined(HAL_USBH_USE_MSD) && (HAL_USBH_USE_MSD == TRUE))
...
#elif (HAL_USE_SDC == FALSE) && (defined(HAL_USBH_USE_MSD) && (HAL_USBH_USE_MSD == TRUE))
#define USB_MSD_DRIVE_INDEX         "0:"
#define USB_MSD_DRIVE_INDEX_NUMERIC (0)
#elif (HAL_USE_SDC == TRUE) && (defined(HAL_USBH_USE_MSD) && (HAL_USBH_USE_MSD == FALSE))
#define SD_CARD_DRIVE_INDEX         "0:"
#define SD_CARD_DRIVE_INDEX_NUMERIC (0)
#endif
