...
// WiFi-specific lwIP option overrides for Pico 2 W (RP2350).
...
// and TLS record processing via mbedtls needs significant headroom.
// RP2350 Cortex-M33 has hardware FPU but mbedTLS bignum is still CPU-intensive.
