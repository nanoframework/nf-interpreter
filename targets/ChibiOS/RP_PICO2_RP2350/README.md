# Raspberry Pi Pico 2 (RP2350) — nanoFramework Target

## Overview

This target supports the **Raspberry Pi Pico 2** board with the RP2350 microcontroller running ChibiOS/RT.

- **MCU:** RP2350 — Dual-core ARM Cortex-M33
- **RAM:** 520 KB SRAM
- **Flash:** 4 MB XIP (execute-in-place)
- **RTOS:** ChibiOS/RT (single-core)

## Flashing

The RP2350 uses **UF2 (USB Flashing Format)**. To flash:
...
All 30 GPIO pins (GP0–GP29) are available. Pin numbers in nanoFramework correspond directly to RP2350 GPIO numbers.
...
> **Note:** I2C buses are 0-indexed on RP2350. Bus 0 = I2C0, Bus 1 = I2C1.
