...
#define RP2350_FLASH_PAGE_SIZE   0x100  // 256 B
...
#define LFS0_BLOCK_SIZE     RP2350_FLASH_SECTOR_SIZE
#define LFS0_BLOCK_COUNT    (RP2350_LFS_SIZE / RP2350_FLASH_SECTOR_SIZE)
#define LFS0_BLOCK_CYCLES   100
#define LFS0_CACHE_SIZE     RP2350_FLASH_PAGE_SIZE
