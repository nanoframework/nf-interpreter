...
#define LFS0_TOTAL_SIZE 0x100000
#define LFS0_PAGE_SIZE  0x100

// mapping into littlefs defines
#define LFS0_READ_SIZE      1
#define LFS0_PROG_SIZE      1
#define LFS0_BLOCK_SIZE     0x1000
#define LFS0_BLOCK_COUNT    LFS0_TOTAL_SIZE / LFS0_BLOCK_SIZE
#define LFS0_BLOCK_CYCLES   100
#define LFS0_CACHE_SIZE     LFS0_PAGE_SIZE
