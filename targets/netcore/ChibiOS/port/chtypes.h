...
typedef uint64_t tprio_t;      /**< Thread priority.           */
typedef uint64_t msg_t;        /**< Inter-thread message.      */
typedef int64_t eventid_t;    /**< Numeric event identifier.  */
typedef uint64_t eventmask_t;  /**< Mask of event identifiers. */
typedef uint64_t eventflags_t; /**< Mask of event flags.       */
typedef int64_t cnt_t;        /**< Generic signed counter.    */
typedef uint64_t ucnt_t; /**< Generic unsigned counter.  */
/** @} */
