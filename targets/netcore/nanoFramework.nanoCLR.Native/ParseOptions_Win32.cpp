...
CLR_RT_ParseOptions::Parameter_Generic::Parameter_Generic(const wchar_t *szName, const wchar_t *szDescription)
...
CLR_RT_ParseOptions::Parameter_Float::Parameter_Float(float *data, const wchar_t *szName, const wchar_t *szDescription)
    : CLR_RT_ParseOptions::Parameter(szName, szDescription)
{
    m_dataPtr = data ? data : &m_dataParsed;
}
...
CLR_RT_ParseOptions::Command_SetFlag::Command_SetFlag(bool *data, const wchar_t *szName, const wchar_t *szDescription)
