...
void app_main()
{
    ...
    // start receiver task pinned to the 1st core
    xTaskCreatePinnedToCore(&receiver_task, "ReceiverThread", 2048, NULL, 5, NULL, 0);

    // start the CLR main task pinned to 2nd core
