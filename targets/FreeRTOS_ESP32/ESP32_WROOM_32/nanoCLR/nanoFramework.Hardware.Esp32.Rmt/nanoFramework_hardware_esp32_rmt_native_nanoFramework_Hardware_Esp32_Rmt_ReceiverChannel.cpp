...
HRESULT Library_nanoFramework_hardware_esp32_rmt_native_nanoFramework_Hardware_Esp32_Rmt_ReceiverChannel::
    CreateRmtArrayOnStack( CLR_RT_StackFrame& stack, CLR_INT32 numItems,  CLR_RT_TypeDef_Index & rmtCommandTypeDef, CLR_RT_HeapBlock ** arrayDataPtr )
{
    NANOCLR_HEADER();
    {
        ...
        NANOCLR_CHECK_HRESULT(CLR_RT_HeapBlock_Array::CreateInstance( stack.PushValue(), numItems, rmtCommandTypeDef)); //g_CLR_RT_WellKnownTypes.m_Object ));
...
esp_err_t Library_nanoFramework_hardware_esp32_rmt_native_nanoFramework_Hardware_Esp32_Rmt_ReceiverChannel::
    ...
    gpio_num_t gpio,
    int32_t bufferSizeRmtItems, int32_t clockDiv)
{
    ...
    RmtChannel::registredChannels.emplace(std::piecewise_construct, std::forward_as_tuple(channel), std::forward_as_tuple());
