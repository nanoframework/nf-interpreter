...
__attribute__((section(".ramfunc.$RAM2"))) bool iMXRTFlexSPIDriver_InitializeDevice(void *context)
{
    (void)context;
...
bool iMXRTFlexSPIDriver_Read(void *context, ByteAddress startAddress, unsigned int numBytes, unsigned char *buffer)
{
    (void)context;
