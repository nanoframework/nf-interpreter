# How to Build the ESP32 NanoClr on Windows using Visual Code, flash it into the ESP32, debug it and flash your fist C# apllication into the ESP32
...
- [Python 3.6.5](https://www.python.org/ftp/python/3.6.5/python-3.6.5.exe) For uploading the nanoCLR to the ESP32.
...
This has already been done and the libraries can be just downloaded.
...
Fork the Nanoframework/nf-interpreter to your own github repo and clone the forked github repo to your Windows system. (GitHub Desktop application)
You should use the develop branch or currently for the ESP32 development you can use the develop-network. Don't use the develop-esp32 branch.
...
- Rename the download into a file with ".vsix"W extension
...
Be aware of the foreward slashes in the pathes. The TOOLCHAIN_PREFIX should be set to the directory where the xtensa-esp32-elf is the subdirectory. If you follow the pathes in this guide you can exactly use this:
...
For flashing the nanoCLR into the ESP32 or erase the flash of the ESP32 you need this in the tasks.json file
...
- Press F7 or enter the command "CMake: Build"
- If you get no error you have in the build directory the nanoCLR.bin and partitions_4mb.bin
- The third file that gets flashed into the ESP32 is the C:/ESP32_Tools/libs/bootloader.bin file

# Flash nanoClr to ESP32
- Connect you develop board to the computer to the port that you setup in tasks.json
