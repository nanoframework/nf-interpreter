...
bool CC32xxFlashDriver_Read(void *context, ByteAddress startAddress, unsigned int numBytes, unsigned char *buffer)
{
    ...
    // CC32xx flash is not directly readable via software; reads happen via the hardware
    // memory interface transparently. This stub intentionally does nothing.
    return true;
}

bool CC32xxFlashDriver_Write(
    void *context,
