...
#endif
{
    ...
    HRESULT Load()
    {
		...
		// ************************************************************************* //
		vec.push_back(L"-load");
		vec.push_back(L"..\\packages\\nanoFramework.Windows.Devices.Gpio.1.0.0-preview020\\lib\\Windows.Devices.Gpio.pe");
		...
		// ************************************************************************* //
		vec.push_back(L"-load");
		vec.push_back(L"..\\packages\\nanoFramework.Runtime.Events.1.0.0-preview012\\lib\\nanoFramework.Runtime.Events.pe");
		...
		// ************************************************************************* //
		vec.push_back(L"-load");
		vec.push_back(L"..\\packages\\nanoFramework.Windows.Devices.Spi.1.0.0-preview014\\lib\\Windows.Devices.Spi.pe");
