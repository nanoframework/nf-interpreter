...
__WEAK void sl_usbd_hid_hid0_on_get_report_desc_event(const uint8_t **p_report_ptr,
                                                                uint16_t       *p_report_len);
__WEAK void sl_usbd_hid_hid0_on_get_phy_desc_event(const uint8_t **p_report_ptr,
                                                             uint16_t       *p_report_len);
__WEAK void sl_usbd_hid_hid0_on_set_output_report_event(uint8_t   report_id,
                                                                  uint8_t  *p_report_buf,
                                                                  uint16_t  report_len);
__WEAK void sl_usbd_hid_hid0_on_get_feature_report_event(uint8_t   report_id,
                                                                   uint8_t  *p_report_buf,
                                                                   uint16_t  report_len);
__WEAK void sl_usbd_hid_hid0_on_set_feature_report_event(uint8_t   report_id,
                                                                   uint8_t  *p_report_buf,
                                                                   uint16_t  report_len);
