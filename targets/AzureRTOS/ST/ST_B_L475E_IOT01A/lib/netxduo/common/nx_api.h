...
#define NX_TRACE_INTERNAL_ICMP_RECEIVE                                                                                 \
    304                                 /* I1 = ip ptr, I2 = source IP address, I3 = packet ptr, I4 = header word 0 */
...
#define NX_TRACE_INTERNAL_RARP_RECEIVE                                                                                 \
    320                                 /* I1 = ip ptr, I2 = target IP address, I3 = packet ptr, I4 = header word 1 */
...
#define NX_TRACE_INTERNAL_IO_DRIVER_INITIALIZE                                                                         \
    325 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_LINK_ENABLE                                                                        \
    326 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_LINK_DISABLE                                                                       \
    327 /* I1 = ip ptr                                                              */
...
#define NX_TRACE_INTERNAL_IO_DRIVER_MULTICAST_JOIN                                                                     \
    332 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_MULTICAST_LEAVE                                                                    \
    333 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_STATUS                                                                         \
    334 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_SPEED                                                                          \
    335 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_DUPLEX_TYPE                                                                    \
    336 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_ERROR_COUNT                                                                    \
    337 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_RX_COUNT                                                                       \
    338 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_TX_COUNT                                                                       \
    339 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_GET_ALLOC_ERRORS                                                                   \
    340 /* I1 = ip ptr                                                              */
#define NX_TRACE_INTERNAL_IO_DRIVER_UNINITIALIZE                                                                       \
    341 /* I1 = ip ptr                                                              */
...
#define NX_TRACE_IGMP_LOOPBACK_DISABLE                                                                                 \
    365                                   /* I1 = ip ptr                                                              */
...
#define NX_TRACE_IP_FORWARDING_DISABLE                                                                                 \
    375                                   /* I1 = ip ptr                                                              */
...
#define NX_TRACE_IP_RAW_PACKET_DISABLE                                                                                 \
    381                                   /* I1 = ip ptr                                                              */
...
#define NX_TRACE_TCP_SERVER_SOCKET_UNLISTEN                                                                            \
    411                                /* I1 = ip ptr, I2 = port                                                   */
...
#define NX_TRACE_IP_STATIC_ROUTE_ENABLE                                                                                \
    441 /* I1 = ip_ptr,                                                             */
#define NX_TRACE_IP_STATIC_ROUTE_DISABLE                                                                               \
    442                                  /* I1 = ip_ptr,                                                             */
...
#define NX_TRACE_UDP_SOCKET_INTERFACE_CLEAR                                                                            \
    448 /* I1 = socket_ptr,                                                         */
...
#define NX_TRACE_IP_STATIC_ROUTING_ENABLE                                                                              \
    483 /* I1 = ip_ptr                                                              */
#define NX_TRACE_IP_STATIC_ROUTING_DISABLE                                                                             \
    484                          /* I1 = ip_ptr                                                              */
...
#define NXD_TRACE_IPV6_INITIATE_DAD_PROCESS                                                                            \
    490 /* I1 = ip_ptr                                                              */
...
#define NXD_TRACE_IPV6_INTERFACE_ADDRESS_GET                                                                           \
    493 /* I1 = ip_ptr, I2 = IP address lsw,I3 = prefix length,I4 = interface_index */
#define NXD_TRACE_IPV6_INTERFACE_ADDRESS_SET                                                                           \
    494 /* I1 = ip_ptr, I2 = IP address lsw,I3 = prefix length,I4 = interface_index */
...
#define NXD_TRACE_IP_MAX_PAYLOAD_SIZE_FIND                                                                             \
    496                           /* I1 = src address, I2 = dst address,I3 = payload length,I4 = start offset */
...
#define NX_TRACE_EVENT_UPDATE(e, t, i, a, b, c, d)                                                                     \
    ...
    VOID _nx_trace_object_register(
        UCHAR object_type,
        VOID *object_ptr,
        CHAR *object_name,
        ULONG parameter_1,
...
/* If NX_PACKET_HEADER_PAD is defined, make sure NX_PACKET_HEADER_PAD_SIZE is also defined.  The default is 1, for
...
/* Define the IPsec header size.  The space reserved here is good for ESP/AH header and possiblly IPv4/v6 header in
 * tunnel mode. */
#ifdef FEATURE_NX_IPV6
...
/* For backward compatibility, convert map NXDUO_DISABLE_ICMPV6_ROUTER_ADVERTISEMENT_PROCESS to
...
/* For backward compatibility, convert map NXDUO_DISABLE_ICMPV6_ROUTER_SOLICITATION to
...
/* For backward compatibility, convert map NX_IPV6_DISABLE_PURGE_UNUSED_CACHE_ENTRIES to
...
/* For backward compatibility, convert map NX_DESTINATION_TABLE_SIZE and NXDUO_DESTINATION_TABLE_SIZE to
...
/* For backward compatibility, convert map NX_DUP_ADDR_DETECT_TRANSMITS and NXDUO_DUP_ADDR_DETECT_TRANSMITS to
...
#define NX_ND_MAX_QUEUE_DEPTH 4
    ...
    typedef struct ND_CACHE_ENTRY_STRUCT
    {
        ...
        /*lint -esym(768,ND_CACHE_ENTRY_STRUCT::nx_nd_cache_reserved1) suppress member not referenced. It is reserved
         * for future use. */
        UCHAR nx_nd_cache_reserved1;

        /* Padding.  Reserved for future use. */
        /*lint -esym(768,ND_CACHE_ENTRY_STRUCT::nx_nd_cache_reserved2) suppress member not referenced. It is reserved
         * for future use. */
    ...
    typedef struct NX_IPV6_DEFAULT_ROUTER_ENTRY_STRUCT
    {
        ...
        /*lint -esym(768,NX_IPV6_DEFAULT_ROUTER_ENTRY_STRUCT::nx_ipv6_default_router_entry_reserved) suppress member not
...
#define NX_PACKET_DEBUG(f, l, p)
    ...
    typedef struct NX_PACKET_STRUCT
    {
        ...
        /* nx_packet_identical_copy is to track the IP ID field in the IP header
           ...
           On retransmission, if the flag nx_packet_identical_copy is set, the same IP ID value is used for the
           retransmitted packet. Otherwise the value in the IP ID field is updated with the latest ID value in the IP
           instance.
         */
        ...
        /*lint -esym(768,NX_PACKET_STRUCT::nx_packet_reserved) suppress member not referenced. It is reserved for future
         * use. */
...
#define NX_UDP_SOCKET_MODULE_EXTENSION
    ...
    typedef struct NX_UDP_SOCKET_STRUCT
    {
        ...
        /*lint -esym(768,NX_UDP_SOCKET_STRUCT::nx_udp_socket_reserved_ptr) suppress member not referenced. It is
...
#define NX_TCP_SOCKET_MODULE_EXTENSION
    ...
    typedef struct NX_TCP_SOCKET_STRUCT
    {
        ...
        /*lint -esym(768,NX_TCP_SOCKET_STRUCT::nx_tcp_socket_reserved) suppress member not referenced. It is reserved
         * for future use. */
        ...
        /* This pointer is reserved for application specific use.  */
        /*lint -esym(768,NX_TCP_SOCKET_STRUCT::nx_tcp_socket_reserved_ptr) suppress member not referenced. It is
...
#error "IP fragmentation is not supported if packet chain is disabled."
    ...
    typedef struct NXD_IPV6_ADDRESS_STRUCT
    {
        ...
        /* Reserved. */
        /*lint -esym(768,NXD_IPV6_ADDRESS_STRUCT::reserved) suppress member not referenced. It is reserved for future
         * use. */
        UCHAR reserved;
    } NXD_IPV6_ADDRESS;
    ...
    typedef struct NX_INTERFACE_STRUCT
    {
        ...
        /*lint -esym(768,NX_INTERFACE_STRUCT::nx_interface_reserved) suppress member not referenced. It is reserved for
         * future use. */
...
#define nx_ip_additional_link_info     nx_ip_interface[0].nx_interface_additional_link_info
        ...
        /*lint -esym(768,NX_IP_STRUCT::nx_ip_transmit_no_route_errors) suppress member not referenced. It is reserved
...
#define nx_system_initialize                      _nx_system_initialize
    ...
    UINT _nxde_udp_socket_source_send(
        NX_UDP_SOCKET *socket_ptr,
        NX_PACKET *packet_ptr,
        NXD_ADDRESS *ip_address,
        UINT port,
    ...
    UINT _nxd_udp_socket_source_send(
        NX_UDP_SOCKET *socket_ptr,
        NX_PACKET *packet_ptr,
        NXD_ADDRESS *ip_address,
        UINT port,
    ...
    UINT _nx_udp_socket_source_send(
        NX_UDP_SOCKET *socket_ptr,
        NX_PACKET *packet_ptr,
        ULONG ip_address,
        UINT port,
    ...
    VOID _nx_ip_driver_deferred_enable(
        NX_IP *ip_ptr,
...
#define CHECK_IPV6_ADDRESSES_SAME(addr1, addr2)                                                                        \
    ...
    UINT _nx_utility_base64_encode(
        UCHAR *name,
        UINT name_size,
        UCHAR *base64name,
        UINT base64name_size,
        UINT *bytes_copied);
    UINT _nx_utility_base64_decode(
        UCHAR *base64name,
        UINT base64name_size,
        UCHAR *name,
        UINT name_size,
