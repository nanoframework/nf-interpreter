...
HRESULT Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::EnableInterrupt___VOID( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::DisableInterrupt___VOID( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::Dispose___VOID__BOOLEAN( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::_ctor___VOID__STRING__U8( CLR_RT_StackFrame& stack )
{
    NANOCLR_HEADER(); 
...
CLR_RT_ObjectToEvent_Source* Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::GetEventDispReference( CLR_RT_StackFrame& stack )
{
...
HRESULT Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::GetEventDispatcher( CLR_RT_StackFrame& stack, CLR_RT_HeapBlock_NativeEventDispatcher*& port )
{
    NATIVE_PROFILE_CLR_HARDWARE();
    NANOCLR_HEADER();
...
CLR_RT_HeapBlock_NativeEventDispatcher* Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::GetEventDispatcher( CLR_RT_StackFrame& stack )
{
    NATIVE_PROFILE_CLR_HARDWARE();
...
{  
    ...
    if(FAILED(CLR_RT_HeapBlock_NativeEventDispatcher::CreateInstance( *pThis, pThis[ Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::FIELD___NativeEventDispatcher ] )))
    {
        return NULL;
    }

    // Retrieves instance of 
    Library_nanoframework_runtime_events_native_nanoFramework_Runtime_Events_NativeEventDispatcher::GetEventDispatcher( stack, pNativeDisp );
